...
namespace SprykerSdk\Zed\AopSdk\Business\AsyncApi\Builder;
...
use ReflectionClass;
use SprykerSdk\Zed\AopSdk\Business\Exception\InvalidConfigurationException;
...
class AsyncApiBuilder implements AsyncApiBuilderInterface
{
     ...
     * @param \Generated\Shared\Transfer\AsyncApiRequestTransfer $asyncApiRequestTransfer
     *
     * @throws \SprykerSdk\Zed\AopSdk\Business\Exception\InvalidConfigurationException
     *
     * @return void
     */
