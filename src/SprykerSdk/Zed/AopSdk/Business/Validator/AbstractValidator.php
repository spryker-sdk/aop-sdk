...
abstract class AbstractValidator implements ValidatorInterface
{
    ...
    /**
     * @var \SprykerSdk\Zed\AopSdk\Business\Validator\Finder\FinderInterface
     */
    protected FinderInterface $finder;

    /**
     * @var array<\SprykerSdk\Zed\AopSdk\Business\Validator\FileValidatorInterface>
     */
    protected array $fileValidators;

    /**
     * @param \SprykerSdk\Zed\AopSdk\AopSdkConfig $config
     * @param \SprykerSdk\Zed\AopSdk\Business\Validator\Finder\FinderInterface $finder
     * @param array $fileValidators
     */
    public function __construct(AopSdkConfig $config, FinderInterface $finder, array $fileValidators = [])
    {
        $this->config = $config;
        $this->finder = $finder;
