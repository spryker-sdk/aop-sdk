...
class AsyncApiMessageAttribute implements AsyncApiMessageAttributeInterface
{
    ...
    /**
     * @var \SprykerSdk\Zed\AppSdk\Business\AsyncApi\Message\Attributes\AsyncApiMessageAttributeCollectionInterface|string|int
     */
    protected $value;

    /**
     * @param string $name
     * @param \SprykerSdk\Zed\AppSdk\Business\AsyncApi\Message\Attributes\AsyncApiMessageAttributeCollectionInterface|string|int $value
     */
